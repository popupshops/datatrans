...
class Datatrans::JSON::Transaction
  class Credit
    # Class to credit a transaction https://api-reference.datatrans.ch/#tag/v1transactions/operation/credit
    ...
    def process
      post(datatrans.url(:json_credit_url, transaction_id: params[:transaction_id]),
